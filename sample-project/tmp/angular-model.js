(function(window, angular, undefined) {
  ...
  angular.module('ur.model', []).provider('model', function() {
    ...
    var DEFAULT_METHODS = {
      ...
      $class: {
        all: function(data, headers) {
          return $request(null, this, 'GET', data, null, headers);
        },
        first: function(data) {
        ...
        update: function(query, data, headers) {
          return $request(null, this, 'PATCH', data, query, headers);
        },
    ...
    function $request(object, model, method, data, query, headers) {
